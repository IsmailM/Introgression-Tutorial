...
help_text << "\n"
help_text << "    -m       Specify a substitution model other than HKY (default: off).\n"
help_text << "             If this option is not used, the HKY model will be applied.\n"
help_text << "             The following alternative substitution models can be chosen: GTR, RB.\n"
help_text << "\n"
...
help_text << "\n"
help_text << "    -u       Use the UCNL clock instead of the strict molecular clock (default: off)\n"
help_text << "\n"
...
valid_substitution_models = ["hky","gtr","rb"]
raise "Please specify a substitution model with the option -m (Available options: HKY, GTR, and RB)!" unless valid_substitution_models.include?(substitution_model)
...
if starbeast
    xml_string << "<beast beautitemplate=\"StarBeast\" beautistatus=\"\" namespace=\"beast.core:beast.evolution.alignment:beast.evolution.tree.coalescent:beast.core.util:beast.evolution.nuc:beast.evolution.operators:beast.evolution.sitemodel:beast.evolution.substitutionmodel:beast.evolution.likelihood\" version=\"2.0\">\n"
else
    xml_string << "<beast beautitemplate=\"Standard\" beautistatus=\"\" namespace=\"beast.core:beast.evolution.alignment:beast.evolution.tree.coalescent:beast.core.util:beast.evolution.nuc:beast.evolution.operators:beast.evolution.sitemodel:beast.evolution.substitutionmodel:beast.evolution.likelihood\" version=\"2.0\">\n"
end
xml_string << "\n"
...
if path_sampling
    ...
    xml_string << "\t\tnrofsteps=\"64\">\n"
    xml_string << "\t\tcp -r BEASTii tmp/step0\n"
    xml_string << "\t\tcp -r BEASTii tmp/step1\n"
    xml_string << "\t\tcp -r BEASTii tmp/step2\n"
    xml_string << "\t\tcp -r BEASTii tmp/step3\n"
    xml_string << "\t\tcp -r BEASTii tmp/step4\n"
    xml_string << "\t\tcp -r BEASTii tmp/step5\n"
    xml_string << "\t\tcp -r BEASTii tmp/step6\n"
    xml_string << "\t\tcp -r BEASTii tmp/step7\n"
    xml_string << "\t\tcp -r BEASTii tmp/step8\n"
    xml_string << "\t\tcp -r BEASTii tmp/step9\n"
    xml_string << "\t\tcp -r BEASTii tmp/step10\n"
    xml_string << "\t\tcp -r BEASTii tmp/step11\n"
    xml_string << "\t\tcp -r BEASTii tmp/step12\n"
    xml_string << "\t\tcp -r BEASTii tmp/step13\n"
    xml_string << "\t\tcp -r BEASTii tmp/step14\n"
    xml_string << "\t\tcp -r BEASTii tmp/step15\n"
    xml_string << "\t\tcp -r BEASTii tmp/step16\n"
    xml_string << "\t\tcp -r BEASTii tmp/step17\n"
    xml_string << "\t\tcp -r BEASTii tmp/step18\n"
    xml_string << "\t\tcp -r BEASTii tmp/step19\n"
    xml_string << "\t\tcp -r BEASTii tmp/step20\n"
    xml_string << "\t\tcp -r BEASTii tmp/step21\n"
    xml_string << "\t\tcp -r BEASTii tmp/step22\n"
    xml_string << "\t\tcp -r BEASTii tmp/step23\n"
    xml_string << "\t\tcp -r BEASTii tmp/step24\n"
    xml_string << "\t\tcp -r BEASTii tmp/step25\n"
    xml_string << "\t\tcp -r BEASTii tmp/step26\n"
    xml_string << "\t\tcp -r BEASTii tmp/step27\n"
    xml_string << "\t\tcp -r BEASTii tmp/step28\n"
    xml_string << "\t\tcp -r BEASTii tmp/step29\n"
    xml_string << "\t\tcp -r BEASTii tmp/step30\n"
    xml_string << "\t\tcp -r BEASTii tmp/step31\n"
    xml_string << "\t\tcp -r BEASTii tmp/step32\n"
    xml_string << "\t\tcp -r BEASTii tmp/step33\n"
    xml_string << "\t\tcp -r BEASTii tmp/step34\n"
    xml_string << "\t\tcp -r BEASTii tmp/step35\n"
    xml_string << "\t\tcp -r BEASTii tmp/step36\n"
    xml_string << "\t\tcp -r BEASTii tmp/step37\n"
    xml_string << "\t\tcp -r BEASTii tmp/step38\n"
    xml_string << "\t\tcp -r BEASTii tmp/step39\n"
    xml_string << "\t\tcp -r BEASTii tmp/step40\n"
    xml_string << "\t\tcp -r BEASTii tmp/step41\n"
    xml_string << "\t\tcp -r BEASTii tmp/step42\n"
    xml_string << "\t\tcp -r BEASTii tmp/step43\n"
    xml_string << "\t\tcp -r BEASTii tmp/step44\n"
    xml_string << "\t\tcp -r BEASTii tmp/step45\n"
    xml_string << "\t\tcp -r BEASTii tmp/step46\n"
    xml_string << "\t\tcp -r BEASTii tmp/step47\n"
    xml_string << "\t\tcp -r BEASTii tmp/step48\n"
    xml_string << "\t\tcp -r BEASTii tmp/step49\n"
    xml_string << "\t\tcp -r BEASTii tmp/step50\n"
    xml_string << "\t\tcp -r BEASTii tmp/step51\n"
    xml_string << "\t\tcp -r BEASTii tmp/step52\n"
    xml_string << "\t\tcp -r BEASTii tmp/step53\n"
    xml_string << "\t\tcp -r BEASTii tmp/step54\n"
    xml_string << "\t\tcp -r BEASTii tmp/step55\n"
    xml_string << "\t\tcp -r BEASTii tmp/step56\n"
    xml_string << "\t\tcp -r BEASTii tmp/step57\n"
    xml_string << "\t\tcp -r BEASTii tmp/step58\n"
    xml_string << "\t\tcp -r BEASTii tmp/step59\n"
    xml_string << "\t\tcp -r BEASTii tmp/step60\n"
    xml_string << "\t\tcp -r BEASTii tmp/step61\n"
    xml_string << "\t\tcp -r BEASTii tmp/step62\n"
    xml_string << "\t\tcp -r BEASTii tmp/step63\n"
    if substitution_model == "rb"
        xml_string << "\t\tcp -r RBS tmp/step0\n"
        xml_string << "\t\tcp -r RBS tmp/step1\n"
        xml_string << "\t\tcp -r RBS tmp/step2\n"
        xml_string << "\t\tcp -r RBS tmp/step3\n"
        xml_string << "\t\tcp -r RBS tmp/step4\n"
        xml_string << "\t\tcp -r RBS tmp/step5\n"
        xml_string << "\t\tcp -r RBS tmp/step6\n"
        xml_string << "\t\tcp -r RBS tmp/step7\n"
        xml_string << "\t\tcp -r RBS tmp/step8\n"
        xml_string << "\t\tcp -r RBS tmp/step9\n"
        xml_string << "\t\tcp -r RBS tmp/step10\n"
        xml_string << "\t\tcp -r RBS tmp/step11\n"
        xml_string << "\t\tcp -r RBS tmp/step12\n"
        xml_string << "\t\tcp -r RBS tmp/step13\n"
        xml_string << "\t\tcp -r RBS tmp/step14\n"
        xml_string << "\t\tcp -r RBS tmp/step15\n"
        xml_string << "\t\tcp -r RBS tmp/step16\n"
        xml_string << "\t\tcp -r RBS tmp/step17\n"
        xml_string << "\t\tcp -r RBS tmp/step18\n"
        xml_string << "\t\tcp -r RBS tmp/step19\n"
        xml_string << "\t\tcp -r RBS tmp/step20\n"
        xml_string << "\t\tcp -r RBS tmp/step21\n"
        xml_string << "\t\tcp -r RBS tmp/step22\n"
        xml_string << "\t\tcp -r RBS tmp/step23\n"
        xml_string << "\t\tcp -r RBS tmp/step24\n"
        xml_string << "\t\tcp -r RBS tmp/step25\n"
        xml_string << "\t\tcp -r RBS tmp/step26\n"
        xml_string << "\t\tcp -r RBS tmp/step27\n"
        xml_string << "\t\tcp -r RBS tmp/step28\n"
        xml_string << "\t\tcp -r RBS tmp/step29\n"
        xml_string << "\t\tcp -r RBS tmp/step30\n"
        xml_string << "\t\tcp -r RBS tmp/step31\n"
        xml_string << "\t\tcp -r RBS tmp/step32\n"
        xml_string << "\t\tcp -r RBS tmp/step33\n"
        xml_string << "\t\tcp -r RBS tmp/step34\n"
        xml_string << "\t\tcp -r RBS tmp/step35\n"
        xml_string << "\t\tcp -r RBS tmp/step36\n"
        xml_string << "\t\tcp -r RBS tmp/step37\n"
        xml_string << "\t\tcp -r RBS tmp/step38\n"
        xml_string << "\t\tcp -r RBS tmp/step39\n"
        xml_string << "\t\tcp -r RBS tmp/step40\n"
        xml_string << "\t\tcp -r RBS tmp/step41\n"
        xml_string << "\t\tcp -r RBS tmp/step42\n"
        xml_string << "\t\tcp -r RBS tmp/step43\n"
        xml_string << "\t\tcp -r RBS tmp/step44\n"
        xml_string << "\t\tcp -r RBS tmp/step45\n"
        xml_string << "\t\tcp -r RBS tmp/step46\n"
        xml_string << "\t\tcp -r RBS tmp/step47\n"
        xml_string << "\t\tcp -r RBS tmp/step48\n"
        xml_string << "\t\tcp -r RBS tmp/step49\n"
        xml_string << "\t\tcp -r RBS tmp/step50\n"
        xml_string << "\t\tcp -r RBS tmp/step51\n"
        xml_string << "\t\tcp -r RBS tmp/step52\n"
        xml_string << "\t\tcp -r RBS tmp/step53\n"
        xml_string << "\t\tcp -r RBS tmp/step54\n"
        xml_string << "\t\tcp -r RBS tmp/step55\n"
        xml_string << "\t\tcp -r RBS tmp/step56\n"
        xml_string << "\t\tcp -r RBS tmp/step57\n"
        xml_string << "\t\tcp -r RBS tmp/step58\n"
        xml_string << "\t\tcp -r RBS tmp/step59\n"
        xml_string << "\t\tcp -r RBS tmp/step60\n"
        xml_string << "\t\tcp -r RBS tmp/step61\n"
        xml_string << "\t\tcp -r RBS tmp/step62\n"
        xml_string << "\t\tcp -r RBS tmp/step63\n"
    end
    xml_string << "\t\tcd $(dir)\n"
...
if ucln_clock
    ...
    if starbeast
        gene_tree_ids.each do |g|
            ...
            xml_string << "#{first_tab}\t\t\t\t<Exponential name=\"distr\" mean=\"0.3333\"/>\n"
            xml_string << "#{first_tab}\t\t\t</prior>\n"
        end
    else
...
# Priors of the substitution models.
if substitution_model == "hky"
...
# Priors of the gamma distribution of site rate heterogeneity.
if plus_gamma
...
# Operators on the subsitution model.
if substitution_model == "hky"
    xml_string << "#{first_tab}\t<!-- Operators on the HKY substitution model for each alignment -->\n"
    alignment_ids.each do |a|
        xml_string << "#{first_tab}\t<operator id=\"kappaScale.s:#{a}\" parameter=\"@kappa.s:#{a}\" scaleFactor=\"0.5\" spec=\"ScaleOperator\" weight=\"0.1\"/>\n"
    end
elsif substitution_model == "gtr"
...
if output_file_directory != ""
    Dir.mkdir(output_file_directory) unless Dir.exists?(output_file_directory)
end
...
if write_qsub
    ...
    qsub_string_start = "java -jar -Xmx4g beast.jar -seed #{rand(100000)} #{analysis_id}.xml\n"
    qsub_string_resume = "java -jar -Xmx4g beast.jar -seed #{rand(100000)} -resume #{analysis_id}.xml\n"
    qsub_string_part2 = "\n"
...
if write_slurm
    ...
    slurm_string1 << "#\n"
    slurm_string1 << "#SBATCH --time=144:00:00\n"
    slurm_string1 << "#\n"
    ...
    random = rand(100000)
    slurm_string_start = "/usr/bin/java -jar -Xmx4g beast.jar -threads 3 -seed #{random} -beagle #{analysis_id}.xml\n"
    slurm_string_resume = "/usr/bin/java -jar -Xmx4g beast.jar -threads 3 -seed #{random} -beagle -resume #{analysis_id}.xml\n"
    slurm_string2 = ""
    slurm_string2 << "\n"
    slurm_string2 << "# Copy files back to the submission directory\n"
    slurm_string2 << "cp #{analysis_id}* $SUBMITDIR\n"
    slurm_string2 << "\n"
    slurm_start_file_name = "#{output_file_directory}start.sh"
    ...
    slurm_resume_file_name = "#{output_file_directory}resume.sh"
